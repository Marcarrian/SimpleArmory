...
export class ToysService {
  ...
  // public ToysService($http, $log, LoginService, $routeParams, $window, $q, SettingsService) {
  //   //  cache results
  //   var parsedToys;
  ...
  //   };
  //
  //   function parseItemsObject(categories, character) {
  //     var obj = {'categories': []};
  //     var collected = {};
  ...
  //     character[characterProperty].collected.forEach(item => {
