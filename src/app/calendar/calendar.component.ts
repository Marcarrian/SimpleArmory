...
@Component({
  ...
  templateUrl: './calendar.component.ts',
  styleUrls: ['./calendar.component.scss'],
})
export class CalendarComponent {

  public CalendarCtrl($scope, AchievementsService, $sce, $routeParams, $window, SettingsService) {
    ...
    function buildRows(month, year, achByMonths, charname) {
      ...
      for (var day = 1; day <= 31; day++) {
        ...
        if (achByMonths[lookup] && achByMonths[lookup][day]) {
          ...
          achievs.sort(this.achievementDaySort);
  ...
  public achievementDaySort(achieve1, achieve2) {
