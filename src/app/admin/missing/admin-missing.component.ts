...
@Component({
  selector: 'app-admin-missing',
  templateUrl: './admin-missing.component.html',
  styleUrls: ['./admin-missing.scss'],
})
export class AdminMissingComponent {

  constructor() {
  }

  public AdminMissing($scope, AdminService, SettingsService) {
